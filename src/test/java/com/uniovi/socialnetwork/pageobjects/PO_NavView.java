...
public class PO_NavView extends PO_View{
     ...
     * tipo type con el texto Destino * @param driver: apuntando al navegador abierto actualmente.
    ...
    public static void clickMenu(WebDriver driver, String textOption) {
        //CLickamos en la opción de registro y esperamos a que se cargue el enlace de Registro.
        List<WebElement> elements = SeleniumUtils.waitLoadElementsBy(driver, "text", textOption, getTimeout());
        elements.get(0).click();
    }
